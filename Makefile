...
top: top.v ${TB_DIR}/top_test.v cnt_ones_thermo header len_to_mask miss_msg_det countdown
	iverilog ${FLAGS} -s top_test ${DEFINES} -o ${BUILD}/top cnt_ones_thermo.v countdown.v len_to_mask.v header.v miss_msg_det.v top.v ${TB_DIR}/top_test.v
